...
|Asetus  <br/> |Kuvaus  <br/> |
|:-----|:-----|
|Office-sovellusten käyttäminen edellyttää PIN-koodia tai sormenjälkeä  <br/> |Jos tämä asetus **on käytössä**, käyttäjien on annettava toinen todennusmuoto käyttäjänimen ja salasanan lisäksi, ennen kuin he Office käyttää sovelluksia mobiililaitteissaan.  <br/> |
