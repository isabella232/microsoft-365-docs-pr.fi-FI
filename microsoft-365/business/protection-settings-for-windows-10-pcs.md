...
|Estä potentiaalisesti haitallisen sisällön käyttäminen Internetissä  <br/> |Tämän asetuksen avulla voit estää lähtevien käyttäjien yhteydet sellaisten Internet-sijaintien kanssa, jotka voivat isännöidä tietojenkalasteluhuijauksia, hyödyntää tai muuta haitallista sisältöä. Tämä asetus on käytettävissä vain, jos Windows Defenderin virustentorjunnan asetuksena on **käytössä**. Lisä tietoja on kohdassa [verkon suojaaminen](https://docs.microsoft.com/windows/security/threat-protection/windows-defender-antivirus/configure-real-time-protection-windows-defender-antivirus).  <br/> |
