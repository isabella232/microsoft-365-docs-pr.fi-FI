...
5. Laajenna **Suojatut Windows 10 -laitteet** \> määritä haluamasi asetukset. Lisätietoja on [Käytettävissä olevat asetukset](protection-settings-for-windows-10-pcs.md#bkmk_availablesettings) -kohdassa. 
